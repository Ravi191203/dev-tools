  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <div className="absolute inset-0 overflow-hidden">
        <FloatingElement className="top-20 left-10 text-4xl" delay={0}>⚡</FloatingElement>
        <FloatingElement className="top-40 right-20 text-5xl" delay={1}>🚀</FloatingElement>
        <FloatingElement className="bottom-32 left-1/4 text-4xl" delay={2}>✨</FloatingElement>
        <FloatingElement className="top-1/3 left-1/2 text-3xl" delay={3}>⭐</FloatingElement>
        <FloatingElement className="bottom-20 right-10 text-4xl" delay={4}>🌟</FloatingElement>
      </div>

      {/* Background blur circles */}
      <div className="absolute top-0 left-0 w-72 h-72 rounded-full blur-3xl" style={{
      ...
      <div className="absolute bottom-0 left-1/3 w-80 h-80 rounded-full blur-3xl" style={{
      ...
      <div className="relative z-10 min-h-screen py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          <div className="mb-8">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full border text-white text-sm font-medium mb-6 shadow-lg" style={{
          ...
          <div className="flex justify-center gap-8 mb-12">
            <div className="text-center px-6 py-4 rounded-2xl border shadow-xl" style={{
              background: 'rgba(255, 255, 255, 0.1)',
              backdropFilter: 'blur(20px)',
              borderColor: 'rgba(255, 255, 255, 0.2)'
            }}>
            ...
            >
              ...
              >
                <div className="relative mb-6">
                  <div className={`w-16 h-16 bg-gradient-to-br ${tool.gradientFrom} ${tool.gradientTo} rounded-2xl flex items-center justify-center text-3xl mb-4 transform group-hover:scale-110 transition-all duration-500 shadow-2xl backdrop-blur-sm border border-white/20`}>
                    {tool.icon}
                  </div>
                  <div className={`w-16 h-1 bg-gradient-to-r ${tool.gradientFrom} ${tool.gradientTo} rounded-full opacity-60`}></div>
                </div>
                <div className="relative z-10">
                  ...
                  <button className={`w-full bg-gradient-to-r ${tool.gradientFrom} ${tool.gradientTo} text-white font-semibold py-3 px-6 rounded-2xl shadow-2xl transform transition-all duration-300 hover:shadow-3xl hover:scale-105 active:scale-95 backdrop-blur-sm border border-white/20`}>
                ...
                <div className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${tool.gradientFrom} ${tool.gradientTo} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 -z-10`}></div>
